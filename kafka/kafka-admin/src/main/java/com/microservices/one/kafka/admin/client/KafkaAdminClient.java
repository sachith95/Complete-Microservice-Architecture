package com.microservices.one.kafka.admin.client;

import com.microservices.one.config.KafkaConfigData;
import com.microservices.one.config.RetryConfigData;
import com.microservices.one.kafka.admin.exception.KafkaClientException;
...
public class KafkaAdminClient {
    ...
    public void createTopic(){
        ...
        try {
           ...
           throw new KafkaClientException("Reached max number of retry for creating topic(s)", e);
        }
        checkTopicsCreated();
    }
    ...
    private CreateTopicsResult doCreateTopic(RetryContext retryContext) {
        ...
        LOG.info("Creating {} topics(s), attempts {}");
